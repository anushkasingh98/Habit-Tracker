...
class ProfileViewController: UIViewController {
    ...
    @IBOutlet weak var addNgoButton: UIButton!
    
    @IBOutlet weak var nanhiKaliButton: UIButton!
    
    @IBOutlet weak var goonjButton: UIButton!
    
    @IBOutlet weak var kathaButton: UIButton!
    ...
    */
    ...
    @IBAction func addNgoButtonTapped(_ sender: Any) {
    }
    
    @IBAction func myGroupButtonTapped(_ sender: Any) {
    }
    
    @IBAction func nanhiKaliButtonTapped(_ sender: Any) {
    }
    
    @IBAction func goonjButtonTapped(_ sender: Any) {
    }
    
    @IBAction func kathaButtonTapped(_ sender: Any) {
    }
